    ...
    <div className="min-h-screen flex flex-col">
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-background/95 backdrop-blur-lg border-t border-gray-800 z-40">
        <div className="flex justify-around items-center h-12 max-w-4xl mx-auto">
          <Link 
            href="/" 
            className={`flex flex-col items-center gap-0.5 px-6 py-1 rounded-lg transition-colors ${pathname === "/" ? "text-primary" : "text-gray-400 hover:text-gray-300"}`}
          >
          ...
          <Link 
            href="/playground" 
            className={`flex flex-col items-center gap-0.5 px-6 py-1 rounded-lg transition-colors ${pathname === "/playground" ? "text-primary" : "text-gray-400 hover:text-gray-300"}`}
          >
